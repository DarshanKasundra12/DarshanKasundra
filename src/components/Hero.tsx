...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen pt-32 pb-20 relative overflow-hidden bg-black selection:bg-zinc-800 selection:text-white">
      {/* Background Grid Accent */}
      <div 
        className="absolute inset-0 bg-[linear-gradient(to_right,#1a1a1a_1px,transparent_1px),linear-gradient(to_bottom,#1a1a1a_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_60%_at_50%_50%,#000_70%,transparent_100%)] opacity-20 pointer-events-none"
      />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="space-y-4">
              <motion.div
                ...
                className="inline-flex items-center px-3 py-1 rounded-full border border-zinc-800 bg-zinc-900/50 backdrop-blur-sm text-zinc-400 text-xs font-mono mb-2"
              >
              ...
              <h1 className="text-5xl sm:text-7xl font-black text-white leading-none tracking-tighter">
                DARSHAN <br />
                <span className="text-zinc-500">KASUNDRA</span>
              </h1>
                ...
                <AnimatePresence mode="wait">
                  {roleFade && (
                    <motion.div
                      ...
                      animate={{ opacity: 1, y: 0 }}
                      exit={{ opacity: 0, y: -10 }}
                      className="text-2xl sm:text-3xl font-mono text-[#4ade80] font-bold glow-text"
                    >
                      &gt; {roleText[role]}
                    </motion.div>
                  )}
            ...
            <div className="w-full max-w-2xl rounded-xl border border-zinc-800 bg-zinc-950/80 backdrop-blur-xl overflow-hidden shadow-2xl relative">
              <div className="flex items-center px-4 py-3 border-b border-zinc-800 bg-zinc-900/80">
                ...
                <div className="flex-1 text-center text-zinc-500 text-xs font-mono tracking-widest uppercase">
                  bio.sh — 128x64
                </div>
              </div>
              ...
              <div className="p-6 font-mono text-sm sm:text-base space-y-4 max-h-[400px] overflow-auto custom-scrollbar">
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-zinc-400"><span className="text-[#4ade80]">const</span> profile = {'{'}</p>
                </div>
                ...
                <div className="flex flex-wrap gap-4 mt-8">
                  <Button
                    ...
                    size="lg"
                    className="bg-zinc-800 text-zinc-300 hover:bg-white hover:text-black px-6 py-2 text-xs font-bold tracking-wider uppercase rounded-none border border-zinc-700 transition-all duration-300"
                  >
                    Resume.pdf
                  </Button>
                  
                  <div className="flex space-x-4">
                    <a href="https://github.com/DarshanKasundra12" className="p-2 border border-zinc-800 rounded hover:bg-zinc-800 transition-colors"><Github size={18} /></a>
                    <a href="https://www.linkedin.com/in/darshan-kasundra12/" className="p-2 border border-zinc-800 rounded hover:bg-zinc-800 transition-colors"><Linkedin size={18} /></a>
                  </div>
                </div>
              </div>
            </div>
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-[#4ade80]/10 to-transparent blur-3xl rounded-full scale-75 -z-10"></div>
        ...
        >
          <ArrowDown className="text-zinc-600 hover:text-[#4ade80] transition-colors" size={32} />
        </motion.div>
      </div>
    </section>
  );
